...
ASSET_ROOT = SCRIPT_DIR.parents[2]
BACKEND_FALLBACKS = {
    "nc_async_session.py": ASSET_ROOT / "skills" / "netcat-async" / "scripts" / "nc_async_session.py",
    "ssh_async_session.py": ASSET_ROOT / "skills" / "ssh-async" / "scripts" / "ssh_async_session.py",
    "minecraft_async.py": ASSET_ROOT / "skills" / "minecraft-async" / "scripts" / "minecraft_async.py",
}
